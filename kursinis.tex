...
\subsection{Raft Ra klaidų aptikimo praplėtimo korektiškumas}

Šioje dalyje yra detaliau išanalizuojamas Ra klaidų sistemos mazguose aptikimo metodai ir jie yra palyginami su Raft popieriuje pasiūlytų širdies plakimo mechanizmu naudojant \texttt{AppendEntries} užklausas.
